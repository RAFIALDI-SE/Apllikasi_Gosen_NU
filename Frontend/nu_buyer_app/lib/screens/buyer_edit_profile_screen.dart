...
class _BuyerEditProfileScreenState extends State<BuyerEditProfileScreen> {
  ...
  Future<void> _fetchProfileData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://10.0.2.2:8000/api/buyer/me'),
  ...
  Future<void> _updateProfile() async {
    ...
    final uri = Uri.parse('http://10.0.2.2:8000/api/buyer/me/update');
  ...
  Future<void> _ambilAlamatSekarang() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("📍 Alamat berhasil diambil")),
      );
    } catch (e) {
